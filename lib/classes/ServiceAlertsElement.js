 ...
 */
var ServiceAlertsElement = /** @class */ (function () {
    function ServiceAlertsElement() {
    }
    /**
       ...
       */
    ServiceAlertsElement.getSlug = function (rawData) {
        var slugs = [];
        if (ServiceAlertsElement.isType('server', rawData)
        ...
        if (ServiceAlertsElement.isType('service', rawData)
    ...
    /**
       ...
       */
    ServiceAlertsElement.isType = function (type, rawData) {
        if (type === 'server') {
    ...
    /**
       ...
       * @return boolean Check result
       */
    ServiceAlertsElement.isSupport = function (support, rawData) {
        if (support === 'xbox') {
    ...
    /**
       ...
       * @return boolean Check result
       */
    ServiceAlertsElement.isZone = function (zone, rawData) {
        if (zone === 'na') {
    ...
    /**
       ...
       */
    ServiceAlertsElement.getDate = function (rawDate) {
        var dateTime = /([0-9]{4}).([0-9]{2}).([0-9]{2}) - ([0-9]{1,2}):([0-9]{2})/.exec(rawDate);
        return moment()
            .utc()
    ...
    /**
       ...
       */
    ServiceAlertsElement.getType = function (slug) {
    ...
    /**
       ...
       */
    ServiceAlertsElement.getSupport = function (slug) {
    ...
    /**
       ...
       */
    ServiceAlertsElement.getZone = function (slug) {
    ...
    /**
       ...
       */
    ServiceAlertsElement.getStatus = function (rawData) {
    ...
    return ServiceAlertsElement;
}());
exports.default = ServiceAlertsElement;
